...
def next_turn(snake, food):
    ...
    if check_collision(snake) is True:
        game_over()
...
def game_over():
    ...
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2, text="GAME OVER",
                       font=("Consolas", 80, "bold"), fill="red")

window = Tk()
window.title("Snaks game")
...
x = int((screenwidth - window_width) / 2)
y = int((screenheight - window_height) / 2)
